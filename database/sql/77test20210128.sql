...
--
-- Host: localhost
-- Generation Time: 2021-01-28 11:09:29
-- 服务器版本： 5.6.49-log
-- PHP Version: 7.2.32
...
--
-- Indexes for table `user_register_log`
--
ALTER TABLE `user_register_log`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `user_login_log`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `user_register_log`
--
ALTER TABLE `user_register_log`
