...
return [
    ...
    'node' => [
        ...
        'info' => [
            ...
            'ports' => 'کلاینت یک پورت را به صورت تصادفی برای اتصال اولیه انتخاب کرده و به صورت دوره ای به پورت دیگری منتقل می شود.<br/> نمونه فرمت: <code>1234,5000-6000,7044</code>',
        ],
    ...
    'ticket' => [
        ...
        'analysis_title' => 'تحلیل داده',
        'processed_30days' => 'حجم تیکت 30 روزه',
        'first_response_30days' => 'زمان پاسخگویی اولیه 30 روزه',
        'avg_processing_time_30days' => 'میانگین زمان پردازش 30 روزه',
        'today_new' => 'تیکت‌های جدید امروز',
