	...
	<div class="page-content  container-fluid">
		...
		<div class="row">
			...
			<div class="col-lg-7">
				...
				<div class="card">
					<div class="card-block">
						<h4 class="card-title cyan-600"><i class="icon wb-star-outline"></i> {{trans('home.referral_apply_title')}}</h4>
						<table class="text-md-center" data-toggle="table" data-mobile-responsive="true">
							<thead class="thead-default">
							<tr>
								<th data-cell-style="cellStyle"> #</th>
        ...
        function extractMoney() {
            $.post("/extractMoney", {_token: '{{csrf_token()}}'}, function (ret) {
                if (ret.status === 'success') {
                    ...
                    swal.fire(ret.message, {icon: "success", timer: 1000, showConfirmButton: false})
                        .then(() => {
