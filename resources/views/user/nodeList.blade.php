                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <span class="caption-subject">
                                    <span class="label label-info">{{trans('home.account_expire')}}：@if(date('Y-m-d') > Auth::user()->expire_time) {{trans('home.expired')}} @else {{Auth::user()->expire_time}} @endif </span>
                                    &ensp;
                                    <span class="label label-info">{{trans('home.account_bandwidth_usage')}}：{{flowAutoShow(Auth::user()->u + Auth::user()->d)}}（{{flowAutoShow(Auth::user()->transfer_enable)}}）</span>
                                    &ensp;
                                    @if(Auth::user()->traffic_reset_day) <span class="label label-info"> {{trans('home.account_reset_notice', ['reset_day' => Auth::user()->traffic_reset_day])}} </span> @endif
                                </span>
                            </div>
                        </div>
