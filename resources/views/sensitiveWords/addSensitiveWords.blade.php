		...
		<div class="modal-dialog modal-simple modal-center">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button data-dismiss="modal" class="btn btn-danger"> {{trans('home.ticket_table_new_cancel')}} </button>
					<button class="btn btn-primary" onclick="addTicket()"> {{trans('home.ticket_table_new_yes')}} </button>
				</div>
			</div>
		</div>
	</div>
