...
@section('content')
        <div class="hero hero--help">
            <div class="container">
                <h1 class="hero__title">{!! __('static.dsktp_term_hero_title') !!}</h1>
                <p class="hero__text">{{ __('static.dsktp_term_hero_text') }}</p>
            </div>
        </div>
            ...
            <div class="page-content">
                ...
                <div class="questions">
                    <div class="container questions__inner">
                        <h2 class="questions__title">{{ __('static.dsktp_term_list_maintitle') }}</h2>
