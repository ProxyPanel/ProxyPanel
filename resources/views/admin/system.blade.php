                ...
                <div class="nav-tabs-horizontal" data-plugin="tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" data-toggle="tab" href="#webSetting" aria-controls="webSetting"
                                    role="tab">网站常规</a>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-toggle="tab" href="#extend" aria-controls="extend"
                                    role="tab">拓展功能</a>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-toggle="tab" href="#promo" aria-controls="promo"
                                    role="tab">推广系统</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-toggle="tab" href="#notify" aria-controls="notify"
                                    role="tab">通知系统</a>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="dropdown nav-item" role="presentation">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item active" data-toggle="tab" href="#webSetting"
                                        aria-controls="webSetting" role="tab">网站常规</a>
                                <a class="dropdown-item" data-toggle="tab" href="#account" aria-controls="account"
                                        role="tab">账号设置</a>
                                <a class="dropdown-item" data-toggle="tab" href="#node" aria-controls="node" role="tab">节点设置</a>
                                <a class="dropdown-item" data-toggle="tab" href="#extend" aria-controls="extend"
                                        role="tab">拓展功能</a>
                                <a class="dropdown-item" data-toggle="tab" href="#checkIn" aria-controls="checkIn"
                                        role="tab">签到系统</a>
                                <a class="dropdown-item" data-toggle="tab" href="#promo" aria-controls="promo"
                                        role="tab">推广系统</a>
                                <a class="dropdown-item" data-toggle="tab" href="#notify" aria-controls="notify"
                                        role="tab">通知系统</a>
                                <a class="dropdown-item" data-toggle="tab" href="#auto" aria-controls="auto" role="tab">自动任务</a>
                                <a class="dropdown-item" data-toggle="tab" href="#other" aria-controls="other"
                                        role="tab">LOGO|客服|统计</a>
                                <a class="dropdown-item" data-toggle="tab" href="#payment" aria-controls="payment"
                                        role="tab">支付系统</a>
                            </div>
                        </li>
                    </ul>
                    <div class="tab-content py-35 px-35">
                                ...
                                <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('website_name')">修改</button></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('website_url')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="email" class="form-control" id="AppStore_id"
                                                            value="{{$AppStore_id}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('AppStore_id')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="password" class="form-control" id="AppStore_password"
                                                            value="{{$AppStore_password}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('AppStore_password')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="email" class="form-control" id="webmaster_email"
                                                            value="{{$webmaster_email}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('webmaster_email')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="website_security_code">网站安全码</label>
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="website_security_code"
                                                            value="{{$website_security_code}}"/>
                                                    <span class="input-group-append">
														<button class="btn btn-info" type="button"
                                                                onclick="makeWebsiteSecurityCode()">生成</button>
														<button class="btn btn-primary" type="button"
                                                                onclick="update('website_security_code')">修改</button>
													</span>
                                                </div>
                                            </div>
                                            <span class="text-help offset-md-3">非空时必须通过 <a href="/login?securityCode="
                                                        target="_blank">安全入口</a> 加上安全码才可访问 </span>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label" for="is_forbid_china">阻止大陆访问</label>
                                            <span class="col-md-9"><input type="checkbox" id="is_forbid_china"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="is_forbid_oversea">阻止海外访问</label>
                                            <span class="col-md-9"><input type="checkbox" id="is_forbid_oversea"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_forbid_robot"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="maintenance_mode"
                                                        data-plugin="switchery"
                                                        @if($maintenance_mode) checked
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input type="datetime-local" class="form-control"
                                                            id="maintenance_time" value="{{$maintenance_time}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('maintenance_time')">修改</button></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <textarea class="form-control" rows="3"
                                                            id="maintenance_content">{{$maintenance_content}}</textarea>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('maintenance_content')">修改</button></span>
                                                </div>
                                            </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_register"
                                                        data-plugin="switchery"
                                                        @if($is_register) checked
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <select class="col-md-3" id="is_invite_register" data-plugin="selectpicker"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="is_activate_account">激活账号</label>
                                            <select class="col-md-4" id="is_activate_account" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_reset_password"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_free_code"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_rand_port"
                                                        data-plugin="switchery"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="min_port"
                                                            value="{{$min_port}}"
                                                    ...
                                                    <input type="number" class="form-control" id="max_port"
                                                            value="{{$max_port}}"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_user_rand_port"
                                                        data-plugin="switchery"
                                                        @if($is_user_rand_port) checked
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="default_days"
                                                            value="{{$default_days}}"/>
                                                    <div class="input-group-append">
                                                    </div>
                                                    <span class="input-group-text">天</span>
                                                    <button class="btn btn-primary" type="button"
                                                            onclick="updateFromInput('default_days','0')">修改
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="default_traffic"
                                                            value="{{$default_traffic}}"/>
                                                    <div class="input-group-append">
                                                    </div>
                                                    <span class="input-group-text">MB</span>
                                                    <button class="btn btn-primary" type="button"
                                                            onclick="updateFromInput('default_traffic','0')">修改
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="invite_num"
                                                            value="{{$invite_num}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="updateFromInput('invite_num','0')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="reset_password_times">重置密码次数</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="reset_password_times"
                                                            value="{{$reset_password_times}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="updateFromInput('reset_password_times','0')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="is_email_filtering">邮箱过滤机制</label>
                                            <select class="col-md-3" id="is_email_filtering" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="active_times"
                                                            value="{{$active_times}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="updateFromInput('active_times','0')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="register_ip_limit">同IP注册限制</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="register_ip_limit"
                                                            value="{{$register_ip_limit}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="updateFromInput('register_ip_limit','0')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="initial_labels_for_user">用户初始标签</label>
                                            <select class="col-md-7 show-tick" id="initial_labels_for_user"
                                                    data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                    onchange="updateFromOther('multiSelect','initial_labels_for_user')"
                                                    multiple>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="user_invite_days">用户-邀请码有效期</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="user_invite_days"
                                                            value="{{$user_invite_days}}"/>
                                                    <div class="input-group-append">
                                                    </div>
                                                    <span class="input-group-text">天</span>
                                                    <button class="btn btn-primary" type="button"
                                                            onchange="updateFromOther('user_invite_days','1',false)">修改
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="url" class="form-control" id="subscribe_domain"
                                                            value="{{$subscribe_domain}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('subscribe_domain')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="subscribe_max"
                                                            value="{{$subscribe_max}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="updateFromInput('subscribe_max','0')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="mix_subscribe"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="rand_subscribe"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="is_custom_subscribe">高级订阅</label>
                                            <span class="col-md-9"><input type="checkbox" id="is_custom_subscribe"
                                                        data-plugin="switchery"
                                                        @if($is_custom_subscribe) checked
                                                        @endif onchange="updateFromOther('switch','is_custom_subscribe')"></span>
                                            <span
                                                    class="text-help offset-md-3"> 启用后，订阅信息顶部将显示过期时间、剩余流量（Quantumult有特殊效果） </span>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_namesilo"
                                                        data-plugin="switchery"
                                                        @if($is_namesilo) checked
                                                        @endif onchange="updateFromOther('switch','is_namesilo')"></span>
                                            <span class="text-help offset-md-3"> 添加、编辑节点的绑定域名时自动更新域名DNS记录值为节点IP（<a
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="namesilo_key"
                                                            value="{{$namesilo_key}}"
                                                            placeholder="填入Namesilo上申请的API KEY"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('namesilo_key')">修改</button></span>
                                                </div>
                                            </div>
                                            <span class="text-help offset-md-3"> 域名必须是<a
                                                        href="https://www.namesilo.com/?rid=326ec20pa" target="_blank">www.namesilo.com</a>上购买的 </span>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="admin_invite_days">管理员-邀请码有效期</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="admin_invite_days"
                                                            value="{{$admin_invite_days}}"/>
                                                    <div class="input-group-append">
                                                    </div>
                                                    <span class="input-group-text">天</span>
                                                    <button class="btn btn-primary" type="button"
                                                            onchange="updateFromInput('admin_invite_days','1',false)">修改
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <select class="col-md-5" id="is_captcha" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="geetest_id"
                                                            value="{{$geetest_id}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('geetest_id')">修改</button></span>
                                                </div>
                                            </div>
                                            <span class="text-help offset-md-3"> 本功能需要 <a
                                                        href="https://auth.geetest.com/login/" target="_blank">极验后台</a> 申请权限及应用 </span>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="geetest_key"
                                                            value="{{$geetest_key}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('geetest_key')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="google_captcha_secret"
                                                            value="{{$google_captcha_secret}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('google_captcha_secret')">修改</button></span>
                                                </div>
                                            </div>
                                            <span class="text-help offset-md-3"> 本功能需要 <a
                                                        href="https://www.google.com/recaptcha/admin" target="_blank">Google reCAPTCHA后台</a> 申请权限及应用 （申请需科学上网，日常验证不用）</span>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="google_captcha_sitekey">网站密钥</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="google_captcha_sitekey"
                                                            value="{{$google_captcha_sitekey}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('google_captcha_sitekey')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 control-label" for="google_captcha_secret">hCaptcha
                                                Secret密钥</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="hcaptcha_secret"
                                                            value="{{$hcaptcha_secret}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('hcaptcha_secret')">修改</button></span>
                                                </div>
                                            </div>
                                            <span class="text-help offset-md-3"> 本功能需要 <a
                                                        href="https://hCaptcha.com/?r=2d46d3aa7a4e" target="_blank">hCaptcha后台</a> 申请权限及应用</span>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label" for="google_captcha_sitekey">hCaptcha
                                                Site Key网站密钥</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="hcaptcha_sitekey"
                                                            value="{{$hcaptcha_sitekey}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('hcaptcha_sitekey')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_checkin"
                                                        data-plugin="switchery"
                                                        @if($is_checkin) checked
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="traffic_limit_time"
                                                            value="{{$traffic_limit_time}}"/>
                                                    <div class="input-group-append">
                                                    </div>
                                                    <span class="input-group-text">分钟</span>
                                                    <button class="btn btn-primary" type="button"
                                                            onclick="updateFromInput('traffic_limit_time','0')">修改
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="min_rand_traffic"
                                                    ...
                                                    <input type="number" class="form-control" id="max_rand_traffic"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="checkbox" id="referral_status" data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <select class="col-md-5" id="referral_type" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="referral_traffic"
                                                            value="{{$referral_traffic}}"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">MB</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onclick="updateFromInput('referral_traffic','0')">修改
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="referral_percent"
                                                            value="{{$referral_percent * 100}}"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">%</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onchange="updateFromInput('referral_percent','0','100')">
                                                            修改
                                                        </button>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="referral_money"
                                                            value="{{$referral_money}}"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">元</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onclick="updateFromInput('referral_money','0')">修改
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="expire_warning"
                                                        data-plugin="switchery"
                                                        @if($expire_warning) checked
                                                        @endif onchange="updateFromOther('switch','expire_warning')"></span>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="expire_days"
                                                            value="{{$expire_days}}"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">天</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onclick="updateFromInput('expire_days','0')">修改
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="traffic_warning"
                                                        data-plugin="switchery"
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">%</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onclick="updateFromInput('traffic_warning_percent','0')">
                                                            修改
                                                        </button>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_node_offline"
                                                        data-plugin="switchery"
                                                        @if($is_node_offline) checked
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="offline_check_times"
                                                            value="{{$offline_check_times}}"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">次</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onclick="updateFromInput('offline_check_times','0','60')">
                                                            修改
                                                        </button>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="nodes_detection"
                                                        data-plugin="switchery"
                                                        @if($nodes_detection) checked
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="detection_check_times">阻断检测提醒</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="detection_check_times"
                                                            value="{{$detection_check_times}}"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">次</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onclick="updateFromInput('detection_check_times','0','12')">
                                                            修改
                                                        </button>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <select class="col-md-5" id="is_notification" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                            ...
                                            <span class="text-help offset-md-3"> 推送节点离线提醒、用户流量异常警告、节点使用报告（<a
                                                        href="javascript:sendTestNotification();">发送测试消息</a>）</span>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="server_chan_key"
                                                            value="{{$server_chan_key}}" placeholder="请到ServerChan申请"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('server_chan_key')">修改</button></span>
                                                </div>
                                            </div>
                                            <span class="text-help offset-md-3"> 启用ServerChan，请务必填入本值（<a
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="url" class="form-control" id="bark_key"
                                                            value="{{$bark_key}}" placeholder="安装并打开Bark后取得"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('bark_key')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_push_bear"
                                                        data-plugin="switchery"
                                                        @if($is_push_bear) checked
                                                        @endif onchange="updateFromOther('switch','is_push_bear')"></span>
                                            <span class="text-help offset-md-3"> 使用PushBear推送微信消息给用户（<a
                                                        href="https://pushbear.ftqq.com/admin/#/signin" target="_blank">创建消息通道</a>） </span>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="push_bear_send_key"
                                                            value="{{$push_bear_send_key}}" placeholder="创建消息通道后即可获取"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('push_bear_send_key')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="push_bear_qrcode">PushBear订阅二维码</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="url" class="form-control" id="push_bear_qrcode"
                                                            value="{{$push_bear_qrcode}}" placeholder="填入消息通道的二维码URL"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('push_bear_qrcode')">修改</button></span>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_clear_log"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="reset_traffic"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="is_subscribe_ban">订阅异常自动封禁</label>
                                            <span class="col-md-9"><input type="checkbox" id="is_subscribe_ban"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="subscribe_ban_times">订阅请求阈值</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="subscribe_ban_times"
                                                            value="{{$subscribe_ban_times}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="updateFromInput('subscribe_ban_times','0')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_traffic_ban"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="traffic_ban_value"
                                                            value="{{$traffic_ban_value}}"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">GB</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onclick="updateFromInput('traffic_ban_value', '1')">修改
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="traffic_ban_time"
                                                            value="{{$traffic_ban_time}}"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">分钟</span>
                                                        <button class="btn btn-primary" type="button"
                                                                onclick="updateFromInput('traffic_ban_time', '0')">修改
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="auto_release_port"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <span class="col-md-9"><input type="checkbox" id="is_ban_status"
                                                        data-plugin="switchery"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-md-3 col-form-label"
                                                    for="node_daily_report">节点使用报告</label>
                                            <span class="col-md-9"><input type="checkbox" id="node_daily_report"
                                                        data-plugin="switchery"
                        ...
                        <div class="tab-pane" id="other" role="tabpanel">
                            <form action="/admin/setExtend" method="post" enctype="multipart/form-data"
                                    class="upload-form" role="form" id="setExtend">
                                {{csrf_field()}}
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-form-label col-md-3"
                                                    for="website_home_logo">首页LOGO</label>
                                            <div class="col-md-9">
                                                <input type="file" id="website_home_logo" data-plugin="dropify"
                                                        data-default-file={{$website_home_logo?:'/assets/images/default.png'}} />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="file" id="website_logo" data-plugin="dropify"
                                                        data-default-file={{$website_logo?:'/assets/images/default.png'}} />
                                                <button type="submit" class="btn btn-success float-right mt-10"> 提 交
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-form-label col-md-3"
                                                    for="website_customer_service">客服代码</label>
                                            <div class="col-md-9">
                                                <textarea class="form-control" rows="10"
                                ...
                                <div class="row pb-70">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <select class="col-md-3" id="is_AliPay" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <select class="col-md-3" id="is_QQPay" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <select class="col-md-3" id="is_WeChatPay" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <select class="col-md-3" id="is_otherPay" data-plugin="selectpicker"
                                                    data-style="btn-outline btn-primary"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('subject_name')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            <label class="col-form-label col-md-3"
                                                    for="website_callback_url">通用支付回调地址</label>
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="website_callback_url"
                                                            value="{{$website_callback_url}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('website_callback_url')">修改</button></span>
                                                </div>
                                            </div>
                                ...
                                <div class="row pb-70">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                本功能需要 <a href="https://open.alipay.com/platform/home.htm"
                                                        target="_blank">蚂蚁金服开放平台</a> 申请权限及应用
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="f2fpay_app_id"
                                                            value="{{$f2fpay_app_id}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('f2fpay_app_id')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="f2fpay_private_key"
                                                            value="{{$f2fpay_private_key}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('f2fpay_private_key')">修改</button></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="f2fpay_public_key"
                                                            value="{{$f2fpay_public_key}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('f2fpay_public_key')">修改</button></span>
                                                </div>
                                            </div>
                                ...
                                <div class="row pb-70">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                请到 <a href="https://codepay.fateqq.com/i/377289" target="_blank">码支付</a>
                                                申请账号，然后下载登录其挂机软件
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="codepay_url"
                                                            value="{{$codepay_url}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('codepay_url')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="codepay_id"
                                                            value="{{$codepay_id}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('codepay_id')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="codepay_key"
                                                            value="{{$codepay_key}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('codepay_key')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row pb-70">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="payjs_mch_id"
                                                            value="{{$payjs_mch_id}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('payjs_mch_id')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="payjs_key"
                                                            value="{{$payjs_key}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('payjs_key')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row pb-70">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                请到 <a
                                                        href="https://merchants.mugglepay.com/user/register?ref=MP904BEBB79FE0"
                                                        target="_blank">麻瓜宝 MugglePay</a> 申请账号
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="bitpay_secret"
                                                            value="{{$bitpay_secret}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('bitpay_secret')">修改</button></span>
                                                </div>
                                            </div>
                                            <span class="text-help offset-md-3">在<a
                                                        href="https://merchants.mugglepay.com/basic/api" target="_blank">API设置</a>中获取后台服务器的秘钥 </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row pb-70">
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                使用商家账号登录<a
                                                        href="https://www.paypal.com/businessprofile/mytools/apiaccess/firstparty"
                                                        target="_blank">API凭证申请页</a>, 同意并获取设置信息
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="paypal_username"
                                                            value="{{$paypal_username}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('paypal_username')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="paypal_password"
                                                            value="{{$paypal_password}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('paypal_password')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('paypal_secret')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6" hidden>
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="paypal_certificate"
                                                            value="{{$paypal_certificate}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('paypal_certificate')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6" hidden>
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="paypal_app_id"
                                                            value="{{$paypal_app_id}}"/>
                                                    <span class="input-group-append"><button class="btn btn-primary"
                                                                type="button"
                                                                onclick="update('paypal_app_id')">修改</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
