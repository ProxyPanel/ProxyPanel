												...
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('website_name')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('AppStore_password')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('webmaster_email')">修改
														</button>
													</span>
												</div>
											</div>
												...
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-info" type="button"
																onclick="makeWebsiteSecurityCode()">生成
														</button>
														<button class="btn btn-primary" type="button"
																onclick="update('website_security_code')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('maintenance_time')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('maintenance_content')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="updateFromInput('invite_num','0')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="updateFromInput('reset_password_times','0')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="updateFromInput('active_times','0')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="updateFromInput('register_ip_limit','0')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('subscribe_domain')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="updateFromInput('subscribe_max','0')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('namesilo_key')">修改
														</button>
													</span>
												</div>
											</div>
											<span class="text-help offset-md-3"> 域名必须是<a
														href="https://www.namesilo.com/?rid=326ec20pa" target="_blank">www.namesilo.com</a>上购买的
											</span>
										</div>
									</div>
									<div class="form-group col-lg-6">
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('geetest_id')">修改
														</button>
													</span>
												</div>
											</div>
											<span class="text-help offset-md-3"> 本功能需要 <a
														href="https://auth.geetest.com/login/" target="_blank">极验后台</a> 申请权限及应用
											</span>
										</div>
									</div>
									<div class="form-group col-lg-6">
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('google_captcha_secret')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('google_captcha_sitekey')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('hcaptcha_secret')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('hcaptcha_sitekey')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('server_chan_key')">修改
														</button>
													</span>
												</div>
											</div>
									...
									<div class="form-group col-lg-6">
										<div class="row">
											...
											<span class="text-help offset-md-3"> 使用PushBear推送微信消息给用户（<a
														href="https://pushbear.ftqq.com/admin/#/signin" target="_blank">创建消息通道</a>）
											</span>
										</div>
									</div>
									<div class="form-group col-lg-6">
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('push_bear_send_key')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('push_bear_qrcode')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="updateFromInput('subscribe_ban_times','0')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('subject_name')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('website_callback_url')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('f2fpay_app_id')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('f2fpay_private_key')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('f2fpay_public_key')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('payjs_mch_id')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('bitpay_secret')">修改
														</button>
													</span>
												</div>
											</div>
											<span class="text-help offset-md-3">在<a
														href="https://merchants.mugglepay.com/basic/api" target="_blank">API设置</a>中获取后台服务器的秘钥
											</span>
										</div>
									</div>
								</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('paypal_username')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('paypal_password')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('paypal_secret')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('paypal_certificate')">修改
														</button>
													</span>
												</div>
											</div>
											...
											<div class="col-md-7">
												<div class="input-group">
													...
													<span class="input-group-append">
														<button class="btn btn-primary"
																type="button"
																onclick="update('paypal_app_id')">修改
														</button>
													</span>
												</div>
											</div>
