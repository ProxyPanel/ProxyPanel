                ...
                <div class="nav-tabs-horizontal" data-plugin="tabs">
                    ...
                    <div class="tab-content py-35 px-35">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input class="form-control" id="website_security_code" type="text"
                                                   value="{{ $configs['website_security_code'] }}" />
                        ...
                        <x-system.tab-pane id="account">
                            ...
                            <x-system.input-limit code="min_port" hcode="max_port" :value="$configs['min_port']" min="1000" max="$('#max_port').val()"
                                                  :hvalue="$configs['max_port']" hmin="$
                        ...
                        <x-system.tab-pane id="payment">
                            <div class="tab-content pb-100 w-p100">
                                ...
                                <x-system.tab-pane id="manual">
                                    ...
                                    @if ($errors->any())
                                        <x-alert class="col-12" type="danger" :message="$errors->all()" />
                                    @endif
                                    @if (Session::has('successMsg'))
                                        <x-alert class="col-12" type="success" :message="Session::pull('successMsg')" />
                                    @endif
