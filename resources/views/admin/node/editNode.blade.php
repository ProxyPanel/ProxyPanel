                                ...
                                <div class="example">
                                        ...
                                        <ul class="col-md-9 list-unstyled list-inline">
                                            <li class="list-inline-item">
                                                <div class="radio-custom radio-primary">
                                                    <input type="radio" name="is_transit"
                                                            value="1" {{$node->is_transit ? 'checked' : ''}}>
                                                    <label>是</label>
                                                </div>
                                            </li>
                                            <li class="list-inline-item">
                                                <div class="radio-custom radio-primary">
                                                    <input type="radio" name="is_transit"
                                                            value="0" {{$node->is_transit ? '' : 'checked'}}>
                                                    <label>否</label>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <ul class="col-md-9 list-unstyled list-inline">
                                            <li class="list-inline-item">
                                                <div class="radio-custom radio-primary">
                                                    <input type="radio" name="is_ddns"
                                                            value="1" {{$node->is_ddns ? 'checked' : ''}}>
                                                    <label>是</label>
                                                </div>
                                            </li>
                                            <li class="list-inline-item">
                                                <div class="radio-custom radio-primary">
                                                    <input type="radio" name="is_ddns"
                                                            value="0" {{$node->is_ddns ? '' : 'checked'}}>
                                                    <label>否</label>
                                                </div>
                                            </li>
                                        </ul>
                                        <span class="text-help offset-md-3"> 动态IP节点需要<a
                                                    href="https://github.com/NewFuture/DDNS" target="_blank">配置DDNS</a>，对此类型节点，节点阻断功能会通过域名进行检测 </span>
                                    </div>
                                    <div class="form-group row">
                                        <label for="name" class="col-md-3 col-form-label"> 节点名称 </label>
                                        <input type="text" class="form-control col-md-4" name="name" id="name"
                                                value="{{$node->name}}" autofocus required>
                                        <input type="hidden" name="id" value="{{$node->id}}">
                                    </div>
                                    <div class="form-group row">
                                        <label for="server" class="col-md-3 col-form-label"> 域名 </label>
                                        <input type="text" class="form-control col-md-4" name="server" id="server"
                                                value="{{$node->server}}" placeholder="服务器域名地址，填则优先取域名地址">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control col-md-4" name="ip" id="ip"
                                                value="{{$node->ip}}" placeholder="服务器IPv4地址"
                                                {{$node->is_ddns ? 'readonly=readonly' : ''}} required>
                                    </div>
                                    <div class="form-group row">
                                        <label for="ipv6" class="col-md-3 col-form-label"> IPv6地址 </label>
                                        <input type="text" class="form-control col-md-4" name="ipv6" id="ipv6"
                                                value="{{$node->ipv6}}" placeholder="服务器IPv6地址，填写则用户可见，域名无效">
                                    </div>
                                    <div class="form-group row">
                                        <label for="ssh_port" class="col-md-3 col-form-label"> SSH端口 </label>
                                        <input type="number" class="form-control col-md-4" name="ssh_port" id="ssh_port"
                                                value="{{$node->ssh_port}}" placeholder="服务器SSH端口" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="number" class="form-control col-md-4" name="traffic_rate"
                                                id="traffic_rate" value="{{$node->traffic_rate}}" step="0.01" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                class="col-md-5 form-control show-tick" id="labels" name="labels"
                                                multiple>
                                            @foreach($label_list as $label)
                                                <option value="{{$label->id}}"
                                                        @if(in_array($label->id, $node->labels)) selected @endif>{{$label->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                class="col-md-5 form-control" name="group_id" id="group_id"
                                                placeholder="请选择">
                                            @if(!$group_list->isEmpty())
                                                @foreach($group_list as $group)
                                                    <option
                                                            value="{{$group->id}}" {{$node->group_id == $group->id ? 'selected' : ''}}>{{$group->name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        ...
                                        <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                            ...
                                            @if(!$country_list->isEmpty())
                                                @foreach($country_list as $country)
                                                    <option
                                                            value="{{$country->code}}" {{$node->country_code == $country->code ? 'selected' : ''}}>{{$country->code}}
                                                        - {{$country->name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control col-md-6" name="desc" id="desc"
                                                value="{{$node->desc}}" placeholder="简单描述">
                                    </div>
                                    <div class="form-group row">
                                        <label for="sort" class="col-md-3 col-form-label">排序</label>
                                        <input type="number" class="form-control col-md-4" name="sort"
                                                value="{{$node->sort}}" id="sort">
                                ...
                                <div class="example">
                                    ...
                                    <div class="ssr-setting {{$node->type == 1 ? '' : 'hidden'}}">
                                        <div class="form-group row">
                                            ...
                                            <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                    class="col-md-5 form-control" name="method" id="method">
                                                @foreach ($method_list as $method)
                                                    <option value="{{$method->name}}"
                                                            @if($method->name == $node->method) selected @endif>{{$method->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                    class="col-md-5 form-control" name="protocol" id="protocol">
                                                @foreach ($protocol_list as $protocol)
                                                    <option value="{{$protocol->name}}"
                                                            @if($protocol->name == $node->protocol) selected @endif>{{$protocol->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group row">
                                            <label for="protocol_param" class="col-md-3 col-form-label"> 协议参数 </label>
                                            <input type="text" class="form-control col-md-4" name="protocol_param"
                                                    id="protocol_param" value="{{$node->protocol_param}}">
                                        </div>
                                        <div class="form-group row">
                                            <label for="obfs" class="col-md-3 col-form-label">混淆</label>
                                            <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                    class="col-md-5 form-control" name="obfs" id="obfs">
                                                @foreach ($obfs_list as $obfs)
                                                    <option value="{{$obfs->name}}"
                                                            @if($obfs->name == $node->obfs) selected @endif>{{$obfs->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group row">
                                            <label for="obfs_param" class="col-md-3 col-form-label"> 混淆参数 </label>
                                            <textarea class="form-control col-md-8" rows="5" name="obfs_param"
                                                    id="obfs_param">{{$node->obfs_param}}</textarea>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="compatible"
                                                                value="1" {{$node->compatible ? 'checked' : ''}}>
                                                        <label>是</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="compatible"
                                                                value="0" {{$node->compatible ? '' : 'checked'}}>
                                                        <label>否</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="is_subscribe"
                                                                value="1" {{$node->is_subscribe ? 'checked' : ''}}>
                                                        <label>允许</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="is_subscribe"
                                                                value="0" {{$node->is_subscribe ? '' : 'checked'}}>
                                                        <label>不允许</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="detectionType" value="0"
                                                                @if ($node->detectionType == 0) checked @endif/>
                                                        <label>关闭</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="detectionType" value="1"
                                                                @if ($node->detectionType == 1) checked @endif/>
                                                        <label>只检测TCP</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="detectionType" value="2"
                                                                @if ($node->detectionType == 2) checked @endif/>
                                                        <label>只检测ICMP</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="detectionType" value="3"
                                                                @if ($node->detectionType == 3) checked @endif/>
                                                        <label>检测全部</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="single"
                                                                value="0" {{$node->single? '' : 'checked'}}>
                                                        <label>关闭</label>
                                                    </div>
                                                </li>
                                            </ul>
                                            <span class="text-help offset-md-3"> 如果启用请配置服务端的<span class="red-700"> <a
                                                            href="javascript:showTnc();">additional_ports</a> </span>信息 </span>
                                        </div>
                                        <div class="single-setting {{!$node->single ? 'hidden' : ''}}">
                                            <div class="form-group row">
                                                <label for="port" class="col-md-3 col-form-label">[单] 端口</label>
                                                <input type="number" class="form-control col-md-4" name="port" id="port"
                                                        value="{{$node->port}}" placeholder="443">
                                                <span class="text-help offset-md-3"> 推荐80或443，服务端需要配置 </span>
                                                <span class="text-help offset-md-3"> 严格模式：用户的端口无法连接，只能通过以下指定的端口进行连接（<a
                                                            href="javascript:showPortsOnlyConfig();">如何配置</a>）</span>
                                            </div>
                                            <div class="form-group row">
                                                <label for="passwd" class="col-md-3 col-form-label">[单] 密码</label>
                                                <input type="text" class="form-control col-md-4" name="passwd"
                                                        id="passwd" value="{{$node->passwd}}" placeholder="password">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- V2ray 设置部分 -->
                                    <div class="v2ray-setting {{$node->type == 2 ? '' : 'hidden'}}">
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control col-md-4" name="v2_alter_id"
                                                    id="v2_alter_id" value="{{$node->v2_alter_id}}" placeholder="16">
                                        </div>
                                        <div class="form-group row">
                                            <label for="v2_port" class="col-md-3 col-form-label">端口</label>
                                            <input type="number" class="form-control col-md-4" name="v2_port"
                                                    id="v2_port" value="{{$node->v2_port}}" placeholder="10087">
                                        </div>
                                        <div class="form-group row">
                                            <label for="v2_method" class="col-md-3 col-form-label">加密方式</label>
                                            <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                    class="col-md-5 form-control" name="v2_method" id="v2_method">
                                                <option value="none" @if($node->v2_method == 'none') selected @endif>
                                                    none
                                                </option>
                                                <option value="aes-128-cfb"
                                                        @if($node->v2_method == 'aes-128-cfb') selected @endif>
                                                    aes-128-cfb
                                                </option>
                                                <option value="aes-128-gcm"
                                                        @if($node->v2_method == 'aes-128-gcm') selected @endif>
                                                    aes-128-gcm
                                                </option>
                                                <option value="chacha20-poly1305"
                                                        @if($node->v2_method == 'chacha20-poly1305') selected @endif>
                                                    chacha20-poly1305
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                    class="col-md-5 form-control" name="v2_net" id="v2_net">
                                                <option value="tcp" @if($node->v2_net == 'tcp') selected @endif>TCP
                                                </option>
                                                <option value="kcp" @if($node->v2_net == 'kcp') selected @endif>
                                                    mKCP（kcp）
                                                </option>
                                                <option value="ws" @if($node->v2_net == 'ws') selected @endif>
                                                    WebSocket（ws）
                                                </option>
                                                <option value="h2" @if($node->v2_net == 'h2') selected @endif>
                                                    HTTP/2（h2）
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                                    class="col-md-5 form-control" name="v2_type" id="v2_type">
                                                <option value="none" @if($node->v2_type == 'none') selected @endif>无伪装
                                                </option>
                                                <option value="http" @if($node->v2_type == 'http') selected @endif>
                                                    HTTP数据流
                                                </option>
                                                <option value="srtp" @if($node->v2_type == 'srtp') selected @endif>
                                                    视频通话数据 (SRTP)
                                                </option>
                                                <option value="utp" @if($node->v2_type == 'utp') selected @endif>BT下载数据
                                                    (uTP)
                                                </option>
                                                <option value="wechat-video"
                                                        @if($node->v2_type == 'wechat-video') selected @endif>微信视频通话
                                                </option>
                                                <option value="dtls" @if($node->v2_type == 'dtls') selected @endif>
                                                    DTLS1.2数据包
                                                </option>
                                                <option value="wireguard"
                                                        @if($node->v2_type == 'wireguard') selected @endif>WireGuard数据包
                                                </option>
                                            </select>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="v2_tls"
                                                                value="1" {{$node->v2_tls? 'checked' : ''}}>
                                                        <label>是</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control col-md-4" name="v2_insider_port"
                                                    value="{{$node->v2_insider_port}}" id="v2_insider_port"
                                                    placeholder="10550">
                                            <span class="text-help offset-md-3"> 内部监听，当端口为0时启用，仅支持<a
                                                        href="https://github.com/rico93/pay-v2ray-sspanel-v3-mod_Uim-plugin/"
                                                        target="_blank">rico93版</a> </span>
                                        </div>
                                        <div class="form-group row">
                                            <label for="v2_outsider_port" class="col-md-3 col-form-label">内部端口</label>
                                            <input type="text" class="form-control col-md-4" name="v2_outsider_port"
                                                    value="{{$node->v2_outsider_port}}" id="v2_outsider_port"
                                                    placeholder="443">
                                            <span class="text-help offset-md-3"> 外部覆盖，当端口为0时启用，仅支持<a
                                                        href="https://github.com/rico93/pay-v2ray-sspanel-v3-mod_Uim-plugin/"
                                                        target="_blank">rico93版</a> </span>
                                        </div>
                                    </div>
