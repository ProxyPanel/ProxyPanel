                            ...
                            <div class="example-wrap">
                                ...
                                <div class="example">
                                        ...
                                        <ul class="col-md-9 list-unstyled list-inline">
                                            <li class="list-inline-item">
                                                <div class="radio-custom radio-primary">
                                                    <input type="radio" name="is_transit" value="1">
                                                    <label>是</label>
                                                </div>
                                            </li>
                                            <li class="list-inline-item">
                                                <div class="radio-custom radio-primary">
                                                    <input type="radio" name="is_transit" value="0" checked>
                                                    <label>否</label>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control col-md-4" name="ssh_port" value="22"
                                                id="ssh_port" placeholder="服务器SSH端口" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control col-md-4" name="sort" id="sort"
                                                value="1"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-md-4">
                                            <input type="text" class="form-control" name="bandwidth" value="1000" id="bandwidth" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-md-4">
                                            <input type="text" class="form-control right" name="traffic" value="1000" id="traffic" required>
                                            <span class="input-group-text">G</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="monitor_url" class="col-md-3 col-form-label">监控地址</label>
                                        <input type="text" class="form-control col-md-4" name="monitor_url" value="" id="monitor_url" placeholder="节点实时监控地址">
                                ...
                                <div class="example">
                                    ...
                                    <div class="ssr-setting">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="compatible" value="1">
                                                        <label>是</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="compatible" value="0" checked>
                                                        <label>否</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="is_subscribe" value="1" checked>
                                                        <label>允许</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="is_subscribe" value="0">
                                                        <label>不允许</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="single" value="0" checked>
                                                        <label>关闭</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="single-setting hidden">
                                            <div class="form-group row">
                                                ...
                                                <input type="number" class="form-control col-md-4" name="port"
                                                        value="443" id="port"/>
                                    ...
                                    <div class="v2ray-setting hidden">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control col-md-4" name="v2_host"
                                                    id="v2_host">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control col-md-4" name="v2_path"
                                                    id="v2_path">
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <ul class="col-md-9 list-unstyled list-inline">
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="v2_tls" value="1">
                                                        <label>是</label>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="radio-custom radio-primary">
                                                        <input type="radio" name="v2_tls" value="0" checked>
                                                        <label>否</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="number" class="form-control col-md-4" name="v2_insider_port"
                                                    id="v2_insider_port" value="10550"/>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="number" class="form-control col-md-4" name="v2_outsider_port"
                                                    id="v2_outsider_port" value="443"/>
