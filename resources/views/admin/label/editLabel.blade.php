    ...
    <div class="page-content container">
        <div class="panel">
            ...
            <div class="panel-body">
                <form action="/admin/editLabel" method="post" enctype="multipart/form-data" class="form-horizontal"
                        onsubmit="return Submit()">
                    <div class="form-group row">
                        <label for="name" class="col-form-label col-md-1">标签</label>
                        <input type="text" class="form-control col-md-6" name="name" id="name" value="{{$label->name}}"
                                autofocus required>
                    </div>
                    <div class="form-group row">
                        <label for="sort" class="col-form-label col-md-1">排序</label>
                        <input type="number" class="form-control col-md-6" name="sort" id="sort"
                                value="{{$label->sort}}" required/>
