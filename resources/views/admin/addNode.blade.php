							...
							<div class="example-wrap">
								...
								<div class="example">
									...
									<div class="form-group row">
										...
										<input type="text" class="form-control col-md-4" name="name" id="name" autofocus required>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<input type="text" class="form-control col-md-4" name="ssh_port" value="22" id="ssh_port" placeholder="服务器SSH端口" required>
									...
									<div class="form-group row">
										...
										<input type="text" class="form-control col-md-6" name="desc" id="desc" placeholder="简单描述">
									</div>
									<div class="form-group row">
