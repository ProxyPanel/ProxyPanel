    ...
    <div class="page-content container-fluid">
        <div class="panel">
            ...
            <div class="panel-body">
                <form action="/admin/editUser/{{$user->id}}" method="post" class="form-horizontal"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <input type="text" class="form-control" name="password" id="password"
                                            placeholder="不填则不变" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                        ...
                                        <li class="list-inline-item">
                                            <div class="checkbox-custom checkbox-primary">
                                                <input type="checkbox" name="usage"
                                                        value="1" {{in_array(1, $user->usage) ? 'checked' : ''}} />
                                                <label>手机</label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="checkbox-custom checkbox-primary">
                                                <input type="checkbox" name="usage"
                                                        value="2" {{in_array(2, $user->usage) ? 'checked' : ''}} />
                                                <label>电脑</label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="checkbox-custom checkbox-primary">
                                                <input type="checkbox" name="usage"
                                                        value="3" {{in_array(3, $user->usage) ? 'checked' : ''}} />
                                                <label>路由器</label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="checkbox-custom checkbox-primary">
                                                <input type="checkbox" name="usage"
                                                        value="4" {{in_array(4, $user->usage) ? 'checked' : ''}} />
                                                <label>平板</label>
                                            </div>
                                        </li>
                                    </ul>
                                        ...
                                        <li class="list-inline-item">
                                            <div class="radio-custom radio-primary">
                                                <input type="radio" name="pay_way"
                                                        value="0" {{$user->pay_way == 0 ? 'checked' : ''}} />
                                                <label>免费</label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="radio-custom radio-primary">
                                                <input type="radio" name="pay_way"
                                                        value="1" {{$user->pay_way == 1 ? 'checked' : ''}} />
                                                <label>月付</label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="radio-custom radio-primary">
                                                <input type="radio" name="pay_way"
                                                        value="2" {{$user->pay_way == 2 ? 'checked' : ''}} />
                                                <label>季付</label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="radio-custom radio-primary">
                                                <input type="radio" name="pay_way"
                                                        value="3" {{$user->pay_way == 3 ? 'checked' : ''}} />
                                                <label>半年付</label>
                                            </div>
                                        </li>
                                        <li class="list-inline-item">
                                            <div class="radio-custom radio-primary">
                                                <input type="radio" name="pay_way"
                                                        value="4" {{$user->pay_way == 4 ? 'checked' : ''}} />
                                                <label>年付</label>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <select class="form-control" name="level" id="level" data-plugin="selectpicker"
                                        ...
                                        @if(!$level_list->isEmpty())
                                            @foreach($level_list as $level)
                                                <option
                                                        value="{{$level->level}}" {{$user->level == $level->level ? 'selected' : ''}}>{{$level->level_name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-4 col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-append"><button class="btn btn-danger" type="button"
                                                    data-toggle="modal"
                                                    data-target="#handle_user_balance">充值</button></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-4 col-sm-4">
                                    <div class="input-group input-daterange" data-plugin="datepicker">
                                        ...
                                        <input type="text" class="form-control" name="reset_time" id="reset_time"
                                                @if ($user->reset_time) value="{{$user->reset_time}} @endif"/>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                            class="form-control show-tick" id="labels" name="labels"
                                            placeholder="设置后则可见相同标签的节点" multiple>
                                        @foreach($label_list as $label)
                                            <option value="{{$label->id}}"
                                                    @if(in_array($label->id, $user->labels)) selected @endif>{{$label->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <input type="text" class="form-control" name="wechat" value="{{$user->wechat}}"
                                            id="wechat" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 col-sm-3 col-form-label" for="qq">QQ</label>
                                <div class="col-xl-6 col-sm-8">
                                    <input type="number" class="form-control" name="qq" value="{{$user->qq}}" id="qq"
                                            autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-5 col-sm-8">
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="port" value="{{$user->port}}"
                                                id="port"/>
                                        <span class="input-group-append"><button class="btn btn-success" type="button"
                                                    onclick="makePort()"> <i
                                                        class="icon wb-refresh"></i> </button></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                    ...
                                    <select class="form-control" name="method" id="method" data-plugin="selectpicker"
                                        ...
                                        @foreach ($method_list as $method)
                                            <option value="{{$method->name}}"
                                                    @if($method->name == $user->method) selected @endif>{{$method->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-xl-5 col-sm-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="transfer_enable"
                                                value="{{$user->transfer_enable}}" id="transfer_enable" required>
                                    ...
                                    <select class="form-control" name="protocol" id="protocol"
                                        ...
                                        @foreach ($protocol_list as $protocol)
                                            <option value="{{$protocol->name}}"
                                                    @if($protocol->name == $user->protocol) selected @endif>{{$protocol->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <select data-plugin="selectpicker" data-style="btn-outline btn-primary"
                                        ...
                                        @foreach ($obfs_list as $obfs)
                                            <option value="{{$obfs->name}}"
                                                    @if($obfs->name == $user->obfs) selected @endif>{{$obfs->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <input type="text" class="form-control" name="protocol_param" id="protocol_param"
                                            value="{{$user->protocol_param}}" placeholder="节点单端口时无效"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 col-sm-3 col-form-label" for="obfs_param">混淆参数</label>
                                <div class="col-xl-6 col-sm-8">
                                    <textarea class="form-control" rows="3" name="obfs_param" id="obfs_param"
                                            placeholder="不填则取节点自定义混淆参数">{{$user->obfs_param}}</textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="speed_limit_per_con"
                                                id="speed_limit_per_con" value="{{$user->speed_limit_per_con}}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="speed_limit_per_user"
                                                id="speed_limit_per_user" value="{{$user->speed_limit_per_user}}"/>
                                        <span class="input-group-text">Byte</span>
                                    </div>
                                    <span class="text-help">为 0 时不限速 </span>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="vmess_id" id="vmess_id"
                                                value="{{$user->vmess_id}}"/>
                                        <span class="input-group-append"><button class="btn btn-success" type="button"
                                                    onclick="makeVmessId()"> <i
                                                        class="icon wb-refresh"></i> </button></span>
                                    </div>
                ...
                <form action="#" method="post" class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="number" class="col-sm-4 form-control" name="amount" id="amount"
                                placeholder="填入负值则会扣余额" step="0.01" onkeydown="if(event.keyCode===13){return false;}"/>
                    </div>
                </form>
