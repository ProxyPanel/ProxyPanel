                    ...
                    <div class="form-row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <input type="text" class="form-control" name="password" value="" id="password"
                                            placeholder="留空则自动生成随机密码" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-5 col-sm-8">
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="port" value="{{$last_port}}"
                                                id="port"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-5 col-sm-8">
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="transfer_enable" value="1024"
                                                id="transfer_enable" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <input type="text" class="form-control" name="protocol_param" id="protocol_param"
                                            placeholder="节点单端口时无效" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <textarea class="form-control" rows="3" name="obfs_param" id="obfs_param"
                                            placeholder="不填则取节点自定义混淆参数"></textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="speed_limit_per_con"
                                                id="speed_limit_per_con" value="10737418240" autocomplete="off"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="speed_limit_per_user"
                                                id="speed_limit_per_user" value="10737418240" autocomplete="off"/>
                                        <span class="input-group-text">Byte</span>
                                    </div>
                                    <span class="text-help">为 0 时不限速 </span>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-sm-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="vmess_id" id="vmess_id"
                                                value="{{createGuid()}}" autocomplete="off"/>
                                        <span class="input-group-append"><button class="btn btn-success" type="button"
