            ...
            <div class="panel-body">
                <div class="form-row">
                    <div class="form-group col-lg-3 col-sm-4">
                        <input type="text" class="form-control" name="sn" id="sn" value="{{Request::get('sn')}}"
                                placeholder="券码" autocomplete="off"/>
                    </div>
                    <div class="form-group col-lg-3 col-sm-4">
                ...
                <table class="text-md-center" data-toggle="table" data-mobile-responsive="true">
                    ...
                    @foreach($couponList as $coupon)
                        <tr>
                            ...
                            <td> {{date('Y-m-d', $coupon->available_start)}}
                                ~ {{date('Y-m-d', $coupon->available_end)}} </td>
                            <td>
                                @if($coupon->usage == 1)
                                    @if($coupon->status == '1')
                            ...
                            <td>
                                @if($coupon->status != '1')
                                    <button class="btn btn-danger"
                                            onclick="delCoupon('{{$coupon->id}}','{{$coupon->name}}')"><i
