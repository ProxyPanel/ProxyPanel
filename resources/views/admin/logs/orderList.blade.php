        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-2 col-sm-6">
                        <input type="number" class="form-control" name="order_sn" id="order_sn"
                                value="{{Request::get('order_sn')}}" placeholder="订单号"/>
                    </div>
                    ...
                    <div class="form-group col-lg-2 col-sm-6 btn-group">
                        ...
                        <a href="/admin/orderList" class="btn btn-danger">重 置</a>
                    </div>
                </div>
...
@section('script')
    ...
    <script type="text/javascript">
      ...
      // 搜索
      function Search() {
        window.location.href = '/admin/orderList?email=' + $('#email').val() + '&order_sn=' + $('#order_sn').val() +
