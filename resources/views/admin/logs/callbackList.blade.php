            ...
            <div class="panel-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-2 col-sm-4 btn-group">
                        ...
                        <a href="/payment/callbackList" class="btn btn-danger">重 置</a>
                    </div>
                </div>
                <table class="text-md-center" data-toggle="table" data-mobile-responsive="true">
                    ...
                    @foreach($list as $vo)
                        <tr>
                            ...
                            <td> {{$vo->trade_no}} </td>
                            <td>
                                <a href="/admin/orderList?order_sn={{$vo->out_trade_no}}"
                                        target="_blank"> {{$vo->out_trade_no}} </a>
                            </td>
                            <td> {{$vo->amount}}元</td>
...
@section('script')
    ...
    <script type="text/javascript">
      ...
      // 搜索
      function Search() {
        window.location.href = '/payment/callbackList?out_trade_no=' + $('#trade_no').val() + '&trade_no=' +
            $('#out_trade_no').val() + '&type=' + $('#type option:selected').val() + '&trade_status=' +
            $('#trade_status option:selected').val();
      }
    </script>
@endsection
