...
<body>
    ...
    <div class="page-wrapper">
            ...
            <header class="page-header">
              @if (Request::segment(1) === "vpn-apps" || Request::segment(1) === "price" || Request::segment(2) === "payment-success" || Request::segment(1) === "contact")
                ...
                <div class="page-header__right">
                     <nav class="page-header__nav {{ (Request::segment(1) === 'vpn-apps' || Request::segment(1) === 'price' || Request::segment(2) === 'payment-success' || Request::segment(1) === 'contact') ? ' page-header__nav--dark' : '' }}">
                        <ul>
                    ...
                    @if (!Auth::check())
                    <div class="page-header__actions {{ (Request::segment(1) === 'vpn-apps' || Request::segment(1) === 'price') || Request::segment(2) === 'payment-success'|| Request::segment(1) === 'contact' ? ' page-header__actions--dark' : '' }}">
                    ...
                    @endif
                    <div class="page-header__lang {{ (Request::segment(1) === 'vpn-apps' || Request::segment(1) === 'price' || Request::segment(2) === 'payment-success'|| Request::segment(1) === 'contact') ? ' page-header__lang--dark' : '' }}">
                        <a href="{{ url('lang/en') }}" class="{{  app()->getLocale() === 'en' ? 'is-active' : '' }}">English</a>
                        <a href="{{ url('lang/zh-CN') }}" class="{{  app()->getLocale() === 'zh-CN' ? 'is-active' : '' }}">中文</a>
                    </div>
                </div>
            </header>
            <!-- ./end header -->
